...
import com.hybris.campaigns.constants.CampaignsConstants;



/**
 * This is the extension manager of the Campaigns extension.
 */
public class CampaignsManager extends GeneratedCampaignsManager
{
	...
	{
		return (CampaignsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CampaignsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CampaignsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CampaignsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CampaignsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CampaignsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
