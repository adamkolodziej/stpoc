...
import com.hybris.platform.ticketing.constants.TicketingConstants;



/**
 * This is the extension manager of the Ticketing extension.
 */
public class TicketingManager extends GeneratedTicketingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TicketingManager.class.getName());
	...
	{
		return (TicketingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TicketingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TicketingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TicketingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TicketingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TicketingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
