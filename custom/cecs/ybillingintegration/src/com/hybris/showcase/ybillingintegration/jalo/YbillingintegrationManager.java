 ...
 *  
 */
package com.hybris.showcase.ybillingintegration.jalo;
...
/**
 * This is the extension manager of the Ybillingintegration extension.
 */
public class YbillingintegrationManager extends GeneratedYbillingintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YbillingintegrationManager.class.getName());
	 ...
	 */
	public static YbillingintegrationManager getInstance()
	{
		return (YbillingintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YbillingintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YbillingintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YbillingintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YbillingintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YbillingintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
