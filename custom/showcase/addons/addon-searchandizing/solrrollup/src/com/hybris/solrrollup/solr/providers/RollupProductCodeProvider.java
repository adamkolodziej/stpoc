...
public class RollupProductCodeProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
	...
	private List<FieldValue> createFieldValue(final ProductModel product, final IndexedProperty indexedProperty)
	{
		...
		{	
			final ProductModel resolvedProduct = getSolrRollupService().getRollupProduct(product, product);
