 ...
 *  
 */
package com.hybris.showcase.servicescore.jalo;
...
import com.hybris.showcase.servicescore.constants.ServicescoreConstants;



/**
 * This is the extension manager of the Servicescore extension.
 */
public class ServicescoreManager extends GeneratedServicescoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ServicescoreManager.class.getName());
	 ...
	 */
	public static ServicescoreManager getInstance()
	{
		return (ServicescoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ServicescoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ServicescoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ServicescoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ServicescoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ServicescoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
