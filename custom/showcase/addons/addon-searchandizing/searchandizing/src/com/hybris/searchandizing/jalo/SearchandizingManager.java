 ...
 * 
 */
package com.hybris.searchandizing.jalo;
...
/**
 * This is the extension manager of the Searchandizing extension.
 */
public class SearchandizingManager extends GeneratedSearchandizingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SearchandizingManager.class.getName());
	 ...
	 */
	public static SearchandizingManager getInstance()
	{
		return (SearchandizingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SearchandizingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SearchandizingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SearchandizingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SearchandizingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SearchandizingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
