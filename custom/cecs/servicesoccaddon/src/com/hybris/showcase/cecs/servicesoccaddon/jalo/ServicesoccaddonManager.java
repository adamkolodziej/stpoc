 ...
 *
 */
package com.hybris.showcase.cecs.servicesoccaddon.jalo;
...
import com.hybris.showcase.cecs.servicesoccaddon.constants.ServicesoccaddonConstants;



/**
 * This is the extension manager of the servicesoccaddon extension.
 */
public class ServicesoccaddonManager extends GeneratedServicesoccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ServicesoccaddonManager.class.getName());
	 ...
	 */
	public static ServicesoccaddonManager getInstance()
	{
		return (ServicesoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ServicesoccaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ServicesoccaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ServicesoccaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ServicesoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ServicesoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
