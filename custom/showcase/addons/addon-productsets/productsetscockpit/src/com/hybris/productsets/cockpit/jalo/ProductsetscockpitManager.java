 ...
 *  
 */
package com.hybris.productsets.cockpit.jalo;
...
import com.hybris.productsets.cockpit.constants.ProductsetscockpitConstants;



/**
 * This is the extension manager of the Productsetscockpit extension.
 */
public class ProductsetscockpitManager extends GeneratedProductsetscockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductsetscockpitManager.class.getName());
	 ...
	 */
	public static ProductsetscockpitManager getInstance()
	{
		return (ProductsetscockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductsetscockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductsetscockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductsetscockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductsetscockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductsetscockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
