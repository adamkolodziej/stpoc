 ...
 */
package com.sptel.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(SptelFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SptelFulfilmentProcessConstants.PARENT_PROCESS);
