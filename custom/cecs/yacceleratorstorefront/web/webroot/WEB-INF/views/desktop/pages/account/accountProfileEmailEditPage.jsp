...
<div class="span-24">
	<div class="span-20 last">	
		<div class="accountContentPane clearfix">
			<h2 class="headline"><spring:theme code="text.account.change.email.address" text="Change Email Address"/></h2>
			...
			<form:form action="update-email" method="post" commandName="updateEmailForm">
				...
				<div class="form-actions">
					...
					<ycommerce:testId code="myAccount_profile_SaveUpdates_button">
						<button class="positive btn btn-success" type="submit"><spring:theme code="text.account.profile.saveUpdates" text="Save Updates"/></button>
					</ycommerce:testId>
				</div>
			</form:form>
