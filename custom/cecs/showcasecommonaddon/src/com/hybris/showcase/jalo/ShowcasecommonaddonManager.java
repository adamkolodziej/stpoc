 ...
 *
 */
package com.hybris.showcase.jalo;
...
import com.hybris.showcase.constants.ShowcasecommonaddonConstants;



/**
 * This is the extension manager of the Showcasecommonaddon extension.
 */
public class ShowcasecommonaddonManager extends GeneratedShowcasecommonaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ShowcasecommonaddonManager.class.getName());
	 ...
	 */
	public static ShowcasecommonaddonManager getInstance()
	{
		return (ShowcasecommonaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ShowcasecommonaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ShowcasecommonaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ShowcasecommonaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ShowcasecommonaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ShowcasecommonaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
