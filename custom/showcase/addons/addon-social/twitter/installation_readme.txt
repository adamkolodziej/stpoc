...
<your_storefront_extension_name>.additionalWebSpringConfigs.twitter=classpath:/twitter/web/spring/twitter-web-spring.xml

--> To enable this AddOn, you need to add the following entry to you Storefront extensioninfo.xml 

<requires-extension name="twitter" />

--> You will need add an entry also to your localextension.xml 

	 <extension dir="${HYBRIS_BIN_DIR}/<pathtoaddon>/twitter" />
OR
...
--> To complete the installation of this extension in the HAC : 
 ...
 - enable at least projectdata for yacceleratorcore/yb2bacceleratorcore and twitter extension
