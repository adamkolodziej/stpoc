 ...
 *         &lt;element name="SenderNo" type="{urn:sap-com:document:sap:rfc:functions}char30"/>
 *         &lt;element name="FaxGroup" type="{urn:sap-com:document:sap:rfc:functions}char1"/>
...
public class Bapiadfax {
    ...
    @XmlElement(name = "SenderNo", required = true)
    protected String senderNo;
    @XmlElement(name = "FaxGroup", required = true)
