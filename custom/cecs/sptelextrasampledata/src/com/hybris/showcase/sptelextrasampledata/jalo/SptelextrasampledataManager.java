 ...
 *  
 */
package com.hybris.showcase.sptelextrasampledata.jalo;
...
/**
 * This is the extension manager of the Sptelextrasampledata extension.
 */
public class SptelextrasampledataManager extends GeneratedSptelextrasampledataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SptelextrasampledataManager.class.getName());
	 ...
	 */
	public static SptelextrasampledataManager getInstance()
	{
		return (SptelextrasampledataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SptelextrasampledataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SptelextrasampledataManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SptelextrasampledataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SptelextrasampledataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SptelextrasampledataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
