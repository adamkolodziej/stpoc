						...
						<div class="form_field-elements">
							...
							<div class="control-group">
								<div class="form-field-button">
									<button type="submit" class="form positive btn btn-primary text-uppercase btn-xs-block btn-sm-inline-block visible">Add</button>
									<c:url var="cancelUrl" value="/productlists/list"/>
									<a class="form positive btn btn-primary text-uppercase btn-xs-block btn-sm-inline-block visible" type="button" href="${cancelUrl}">cancel</a>
								</div>
							</div>
						</div>
					</form:form>
