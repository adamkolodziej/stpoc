...
public class AccountPageController extends AbstractSearchPageController {
    ...
    @Resource(name = "addressWithHouseNoValidator")
    ...
    public String getCountryAddressForm(@RequestParam("addressCode") final String addressCode,
                                        @RequestParam("countryIsoCode") final String countryIsoCode, @RequestParam("isEditType") final Boolean isEditType,
                                        final Model model) {
    ...
    private void fillOrderModel(@RequestParam(value = "page", defaultValue = "0") int page, @RequestParam(value = "show", defaultValue = "Page") ShowMode showMode, @RequestParam(value = "sort", required = false) String sortCode, Model model) {
        // Handle paged search results
