 ...
 *
 */
package com.hybris.showcase.loyaltypoints.jalo;
...
import com.hybris.showcase.loyaltypoints.constants.LoyaltypointsaddonConstants;



/**
 * This is the extension manager of the Loyaltypointsaddon extension.
 */
public class LoyaltypointsaddonManager extends GeneratedLoyaltypointsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LoyaltypointsaddonManager.class.getName());
	 ...
	 */
	public static LoyaltypointsaddonManager getInstance()
	{
		return (LoyaltypointsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LoyaltypointsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LoyaltypointsaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LoyaltypointsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LoyaltypointsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LoyaltypointsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
