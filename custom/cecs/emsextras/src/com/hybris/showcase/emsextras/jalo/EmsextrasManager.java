...
import com.hybris.showcase.emsextras.constants.EmsextrasConstants;



/**
 * This is the extension manager of the Emsextras extension.
 */
public class EmsextrasManager extends GeneratedEmsextrasManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EmsextrasManager.class.getName());
	 ...
	 */
	public static EmsextrasManager getInstance()
	{
		return (EmsextrasManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EmsextrasConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmsextrasManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EmsextrasManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EmsextrasManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EmsextrasManager called, current tenant: " + getTenant().getTenantID());
		}
	}
