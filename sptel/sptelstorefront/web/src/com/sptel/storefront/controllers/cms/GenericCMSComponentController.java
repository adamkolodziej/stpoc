 ...
 */
package com.sptel.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('sptelstorefront.generic.cms.component.controller.authorized.group')}")
