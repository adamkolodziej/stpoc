 ...
 */
@Controller
@RequestMapping(value = "/guidedsellingSummaryCheckoutStep")
public class GuidedsellingSummaryCheckoutStepController extends AbstractCheckoutStepController
{

	private final static String GUIDEDSELLING_SUMMARY_CHECKOUT_STEP = "summary";
	...
	{
		return getCheckoutStep(GUIDEDSELLING_SUMMARY_CHECKOUT_STEP);
	}
