 ...
 */
@Controller
@RequestMapping(value = "/guidedsellingOrderCheckoutStep")
public class GuidedsellingOrderCheckoutStepController extends AbstractCheckoutStepController
{

	private final static String GUIDEDSELLING_ORDER_CHECKOUT_STEP = "show-order";
	...
	{
		return getCheckoutStep(GUIDEDSELLING_ORDER_CHECKOUT_STEP);
	}
