 ...
 *  
 */
package com.hybris.campaigns.liveedit.jalo;
...
import com.hybris.campaigns.liveedit.constants.CampaignsliveeditConstants;



/**
 * This is the extension manager of the Campaignsliveedit extension.
 */
public class CampaignsliveeditManager extends GeneratedCampaignsliveeditManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CampaignsliveeditManager.class.getName());
	 ...
	 */
	public static CampaignsliveeditManager getInstance()
	{
		return (CampaignsliveeditManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CampaignsliveeditConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CampaignsliveeditManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CampaignsliveeditManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CampaignsliveeditManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CampaignsliveeditManager called, current tenant: " + getTenant().getTenantID());
		}
	}
