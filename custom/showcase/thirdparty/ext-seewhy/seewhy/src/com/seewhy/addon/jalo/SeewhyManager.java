...
/**
 * This is the extension manager of the Seewhy extension.
 */
public class SeewhyManager extends GeneratedSeewhyManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SeewhyManager.class.getName());
	 ...
	 */
	public static SeewhyManager getInstance()
	{
		return (SeewhyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SeewhyConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SeewhyManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SeewhyManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SeewhyManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SeewhyManager called, current tenant: " + getTenant().getTenantID());
		}
	}
