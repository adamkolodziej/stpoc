 ...
 *
 */
package com.hybris.showcase.ybillingintegrationaddon.hmc;
...
/**
 * Provides necessary meta information about the ybillingintegrationaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.6.0.1
 */
public class YbillingintegrationaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(YbillingintegrationaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.hybris.showcase.ybillingintegrationaddon.hmc.locales";
