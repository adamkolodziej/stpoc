 ...
 * 
 */
package com.hybris.cms.turbocmspages.cockpit.jalo;
...
import com.hybris.cms.turbocmspages.cockpit.constants.TurbocmspagescockpitConstants;



/**
 * This is the extension manager of the Turbocmspagescockpit extension.
 */
public class TurbocmspagescockpitManager extends GeneratedTurbocmspagescockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TurbocmspagescockpitManager.class.getName());
	 ...
	 */
	public static TurbocmspagescockpitManager getInstance()
	{
		return (TurbocmspagescockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TurbocmspagescockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TurbocmspagescockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TurbocmspagescockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TurbocmspagescockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TurbocmspagescockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
