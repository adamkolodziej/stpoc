 ...
 *  
 */
package com.hybris.campaigns.cockpit.jalo;
...
import com.hybris.campaigns.cockpit.constants.CampaignscockpitConstants;



/**
 * This is the extension manager of the Campaignscockpit extension.
 */
public class CampaignscockpitManager extends GeneratedCampaignscockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CampaignscockpitManager.class.getName());
	 ...
	 */
	public static CampaignscockpitManager getInstance()
	{
		return (CampaignscockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CampaignscockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CampaignscockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CampaignscockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CampaignscockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CampaignscockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
