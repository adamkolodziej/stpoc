 ...
 *  
 */
package com.hybris.showcase.emsextras.jalo;
...
import com.hybris.showcase.emsextras.constants.EmsextrasaddonConstants;



/**
 * This is the extension manager of the Emsextrasaddon extension.
 */
public class EmsextrasaddonManager extends GeneratedEmsextrasaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EmsextrasaddonManager.class.getName());
	 ...
	 */
	public static EmsextrasaddonManager getInstance()
	{
		return (EmsextrasaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EmsextrasaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmsextrasaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EmsextrasaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EmsextrasaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EmsextrasaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
