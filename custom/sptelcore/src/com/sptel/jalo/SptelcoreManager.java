...
/**
 * This is the extension manager of the Sptelcore extension.
 */
public class SptelcoreManager extends GeneratedSptelcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SptelcoreManager.class);
	 ...
	 */
	public static SptelcoreManager getInstance()
	{
		return (SptelcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SptelcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SptelcoreManager() // NOPMD 
	{
		LOG.debug("constructor of SptelcoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SptelcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SptelcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
