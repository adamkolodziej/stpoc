 ...
 *  
 */
package de.hybris.platform.promotioncockpit.jalo;
...
import de.hybris.platform.promotioncockpit.constants.PromotioncockpitConstants;


/**
 * This is the extension manager of the promotioncockpit extension.
 */
public class PromotioncockpitManager extends GeneratedPromotioncockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(PromotioncockpitManager.class.getName());
	 ...
	 */
	public static final PromotioncockpitManager getInstance()
	{
		return (PromotioncockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PromotioncockpitConstants.EXTENSIONNAME);
	}
