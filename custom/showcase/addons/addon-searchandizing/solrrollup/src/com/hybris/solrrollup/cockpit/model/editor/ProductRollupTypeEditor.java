package com.hybris.solrrollup.cockpit.model.editor;
 ...
 * 
 */
public class ProductRollupTypeEditor extends DefaultSelectUIEditor
{
	@Override
			...
			final EditorListener listener)
	{
		final AvailableValuesProvider provider = (AvailableValuesProvider) SpringUtil
				.getBean("productRollupTypeAvailableValuesProvider");
