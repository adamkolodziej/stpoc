...
public class CreateProductListPageController extends AbstractAddOnPageController
{
	...
	private static final String CREATE_PRODUCT_LIST_CMS_PAGE = "createProductListPage";
...
//		form.setAddresses(addresses);
		...
		storeCmsPageInModel(model, getContentPageForLabelOrId(CREATE_PRODUCT_LIST_CMS_PAGE));
