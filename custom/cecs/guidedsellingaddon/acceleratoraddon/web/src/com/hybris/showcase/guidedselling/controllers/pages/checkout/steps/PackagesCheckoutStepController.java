 ...
 */
@Controller
@RequestMapping(value = "/packagesCheckoutStep")
public class PackagesCheckoutStepController extends AbstractCheckoutStepController
{

	private final static String PACKAGES_CHECKOUT_STEP = "multi";
	...
	{
		return getCheckoutStep(PACKAGES_CHECKOUT_STEP);
	}
