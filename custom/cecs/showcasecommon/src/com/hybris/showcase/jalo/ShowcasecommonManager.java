...
/**
 * This is the extension manager of the Showcasecommon extension.
 */
public class ShowcasecommonManager extends GeneratedShowcasecommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ShowcasecommonManager.class.getName());
	 ...
	 */
	public static ShowcasecommonManager getInstance()
	{
		return (ShowcasecommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ShowcasecommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ShowcasecommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ShowcasecommonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ShowcasecommonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ShowcasecommonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
