TimeSwitcher = {
    ...
    setTimeOnClick: function ($datePicker) {
        return function (event) {
            var setTimeActionUrl = TimeSwitcher.config.contextPath + "/session/time";
    ...
    resetTimeOnclick: function (event) {
        var setTimeActionUrl = TimeSwitcher.config.contextPath + "/session/time/clear";
