 ...
 *  
 */
package com.hybris.showcase.facebookmock.jalo;
...
import com.hybris.showcase.facebookmock.constants.FacebookmockConstants;



/**
 * This is the extension manager of the Facebookmock extension.
 */
public class FacebookmockManager extends GeneratedFacebookmockManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacebookmockManager.class.getName());
	 ...
	 */
	public static FacebookmockManager getInstance()
	{
		return (FacebookmockManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacebookmockConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacebookmockManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacebookmockManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacebookmockManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacebookmockManager called, current tenant: " + getTenant().getTenantID());
		}
	}
