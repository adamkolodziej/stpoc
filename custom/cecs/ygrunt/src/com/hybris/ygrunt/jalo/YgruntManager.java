 ...
 *  
 */
package com.hybris.ygrunt.jalo;
...
import com.hybris.ygrunt.constants.YgruntConstants;



/**
 * This is the extension manager of the Ygrunt extension.
 */
public class YgruntManager extends GeneratedYgruntManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YgruntManager.class.getName());
	 ...
	 */
	public static YgruntManager getInstance()
	{
		return (YgruntManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YgruntConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YgruntManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YgruntManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YgruntManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YgruntManager called, current tenant: " + getTenant().getTenantID());
		}
	}
