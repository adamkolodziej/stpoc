 ...
 *  
 */
package com.hybris.showcase.cecs.servicesshowcase.jalo;
...
import com.hybris.showcase.cecs.servicesshowcase.constants.ServicesshowcaseConstants;



/**
 * This is the extension manager of the Servicesshowcase extension.
 */
public class ServicesshowcaseManager extends GeneratedServicesshowcaseManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ServicesshowcaseManager.class.getName());
	 ...
	 */
	public static ServicesshowcaseManager getInstance()
	{
		return (ServicesshowcaseManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ServicesshowcaseConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ServicesshowcaseManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ServicesshowcaseManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ServicesshowcaseManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ServicesshowcaseManager called, current tenant: " + getTenant().getTenantID());
		}
	}
