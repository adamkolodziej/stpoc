...
import com.sptel.test.constants.SptelTestConstants;
import com.sptel.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SptelTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/spteltest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/spteltest/import/reviews.impex");
			...
			importImpexFile(context, "/spteltest/import/cstickets.impex");
		}
	}
}
