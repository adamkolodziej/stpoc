...
public class LoginPageController extends AbstractLoginPageController
{
			...
			throws CMSItemNotFoundException
	{
		...
		// CECS-311 - When mobile entitlement is not granted signing up should show meaning full error message: start
		model.addAttribute("loginError", Boolean.valueOf(loginError));
		final Exception loginException = (Exception) session.getAttribute("SPRING_SECURITY_LAST_EXCEPTION");
		if(loginException != null)
		{
			GlobalMessages.addErrorMessage(model, loginException.getLocalizedMessage());
		}
		// CECS-311: end
