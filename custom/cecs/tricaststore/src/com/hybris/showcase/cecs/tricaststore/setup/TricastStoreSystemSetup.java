...
@SystemSetup(extension = TricaststoreConstants.EXTENSIONNAME)
public class TricastStoreSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		final ImportData tricastImportData = new ImportData();
		tricastImportData.setProductCatalogName(TRICAST);
		tricastImportData.setContentCatalogNames(Arrays.asList(TRICAST));
		tricastImportData.setStoreNames(Arrays.asList(TRICAST));
		importData.add(tricastImportData);
...
//		importData.add(extrasImportData);
		...
		if (getSampleDataImportService() instanceof TricastImportService)
		{
			((TricastImportService) getSampleDataImportService()).performPostInitHooks(this, context, importData);
		}
