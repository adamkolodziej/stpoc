...
import com.hybris.showcase.guidedselling.constants.GuidedsellingoccaddonConstants;



/**
 * This is the extension manager of the guidedsellingoccaddon extension.
 */
public class GuidedsellingoccaddonManager extends GeneratedGuidedsellingoccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GuidedsellingoccaddonManager.class.getName());
	 ...
	 */
	public static GuidedsellingoccaddonManager getInstance()
	{
		return (GuidedsellingoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(GuidedsellingoccaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GuidedsellingoccaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GuidedsellingoccaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GuidedsellingoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GuidedsellingoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
