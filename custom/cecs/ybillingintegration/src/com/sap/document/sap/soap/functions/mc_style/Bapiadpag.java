 ...
 *         &lt;element name="PagerType" type="{urn:sap-com:document:sap:rfc:functions}char4"/>
 *         &lt;element name="Pager" type="{urn:sap-com:document:sap:rfc:functions}char30"/>
 *         &lt;element name="PagerNo" type="{urn:sap-com:document:sap:rfc:functions}char30"/>
...
public class Bapiadpag {
    ...
    @XmlElement(name = "PagerType", required = true)
    protected String pagerType;
    @XmlElement(name = "Pager", required = true)
    protected String pager;
    @XmlElement(name = "PagerNo", required = true)
