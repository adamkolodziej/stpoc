...
<a href="${cartUrl}" class="minicart">
	<span class="glyphicon glyphicon-shopping-cart inline-block" title="${component.title}"></span> <span class="inline-block">${component.title}</span>
	<ycommerce:testId code="miniCart_items_label">
		<span class="label label-primary count inline-block">${totalItems}</span>
