 ...
 *
 */
package com.hybris.showcase.ybillingintegrationaddon.jalo;
...
import com.hybris.showcase.ybillingintegrationaddon.constants.YbillingintegrationaddonConstants;



/**
 * This is the extension manager of the Ybillingintegrationaddon extension.
 */
public class YbillingintegrationaddonManager extends GeneratedYbillingintegrationaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YbillingintegrationaddonManager.class.getName());
	 ...
	 */
	public static YbillingintegrationaddonManager getInstance()
	{
		return (YbillingintegrationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YbillingintegrationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YbillingintegrationaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YbillingintegrationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YbillingintegrationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YbillingintegrationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
