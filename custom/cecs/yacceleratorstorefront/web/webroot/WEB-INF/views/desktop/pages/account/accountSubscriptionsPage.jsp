		...
		<div>
			...
			<div>
				<c:if test="${not empty subscriptions}">
					...
					<table id="subscriptions" class="subscriptionsTable table table-bordered table-condensed table-striped">
						<thead>
							<tr>
							...
							<c:forEach items="${subscriptions}" var="subscription">
								...
								<tr>
									...
									<td headers="header6" class="background">
										<button type="button" onclick="window.location='${myAccountSubscriptionDetailsUrl}'" class="function_btn btn btn-primary">
