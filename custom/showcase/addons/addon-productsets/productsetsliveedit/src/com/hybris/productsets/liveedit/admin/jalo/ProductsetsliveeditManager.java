 ...
 *  
 */
package com.hybris.productsets.liveedit.admin.jalo;
...
import com.hybris.productsets.liveedit.admin.constants.ProductsetsliveeditConstants;



/**
 * This is the extension manager of the Productsetsliveedit extension.
 */
public class ProductsetsliveeditManager extends GeneratedProductsetsliveeditManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductsetsliveeditManager.class.getName());
	 ...
	 */
	public static ProductsetsliveeditManager getInstance()
	{
		return (ProductsetsliveeditManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductsetsliveeditConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductsetsliveeditManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductsetsliveeditManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductsetsliveeditManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductsetsliveeditManager called, current tenant: " + getTenant().getTenantID());
		}
	}
