 ...
 *  
 */
package com.hybris.showcase.cecs.mediaserver.jalo;
...
import com.hybris.showcase.cecs.mediaserver.constants.MediaserverConstants;



/**
 * This is the extension manager of the Mediaserver extension.
 */
public class MediaserverManager extends GeneratedMediaserverManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MediaserverManager.class.getName());
	...
	{
		return (MediaserverManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MediaserverConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MediaserverManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MediaserverManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MediaserverManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MediaserverManager called, current tenant: " + getTenant().getTenantID());
		}
	}
