package com.hybris.showcase.cecs.sptelstore.setup.impl;
...
import com.hybris.showcase.cecs.sptelstore.setup.SptelImportService;
 ...
 */
/**
 * Sptel specific (migrated from telcostore) implementation of the
 ...
 * <p>
 */
public class SptelSampleDataImportService extends SampleDataImportService implements SptelImportService
{
	// CECS-28 integrate mediaconversion
	private static final Logger LOG = Logger.getLogger(SptelSampleDataImportService.class);
