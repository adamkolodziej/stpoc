...
import com.hybris.showcase.instantcheckout.constants.InstantcheckoutConstants;



/**
 * This is the extension manager of the Instantcheckout extension.
 */
public class InstantcheckoutManager extends GeneratedInstantcheckoutManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(InstantcheckoutManager.class.getName());
	 ...
	 */
	public static InstantcheckoutManager getInstance()
	{
		return (InstantcheckoutManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				InstantcheckoutConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public InstantcheckoutManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InstantcheckoutManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of InstantcheckoutManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of InstantcheckoutManager called, current tenant: " + getTenant().getTenantID());
		}
	}
