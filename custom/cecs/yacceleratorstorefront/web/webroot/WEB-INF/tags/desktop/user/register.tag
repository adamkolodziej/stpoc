...
<div class="userRegister">
    <div class="form-header">
        <div class="headline"><h3><spring:theme code="register.new.customer" /></h3></div>
        <div class="required text-danger"><spring:theme code="form.required"/></div>
		...
		<div class="form-actions clearfix row vertical-both">
            <div class="col-xs-12 col-sm-5">
                <ycommerce:testId code="register_Register_button">
                    <button type="submit" class="btn btn-primary btn-block"><spring:theme code='${actionNameKey}'/></button>
                </ycommerce:testId>
            </div>
		</div>
	</form:form>
