 ...
 *  
 */
package com.hybris.showcase.showcasecockpits.jalo;
...
import com.hybris.showcase.showcasecockpits.constants.ShowcasecockpitsConstants;



/**
 * This is the extension manager of the Showcasecockpits extension.
 */
public class ShowcasecockpitsManager extends GeneratedShowcasecockpitsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ShowcasecockpitsManager.class.getName());
	 ...
	 */
	public static ShowcasecockpitsManager getInstance()
	{
		return (ShowcasecockpitsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ShowcasecockpitsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ShowcasecockpitsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ShowcasecockpitsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ShowcasecockpitsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ShowcasecockpitsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
