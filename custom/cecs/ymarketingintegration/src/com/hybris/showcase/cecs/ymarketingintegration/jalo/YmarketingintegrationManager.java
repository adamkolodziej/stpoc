 ...
 *  
 */
package com.hybris.showcase.cecs.ymarketingintegration.jalo;
...
/**
 * This is the extension manager of the Ymarketingintegration extension.
 */
public class YmarketingintegrationManager extends GeneratedYmarketingintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YmarketingintegrationManager.class.getName());
	 ...
	 */
	public static YmarketingintegrationManager getInstance()
	{
		return (YmarketingintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YmarketingintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YmarketingintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YmarketingintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YmarketingintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YmarketingintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
