...
import com.hybris.searchandizing.wildwords.constants.WildwordsConstants;



/**
 * This is the extension manager of the Wildwords extension.
 */
public class WildwordsManager extends GeneratedWildwordsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WildwordsManager.class.getName());
	 ...
	 */
	public static WildwordsManager getInstance()
	{
		return (WildwordsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WildwordsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WildwordsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WildwordsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WildwordsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WildwordsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
