 ...
 * 
 */
package com.hybris.commercesearch.searchandizing.cockpit.jalo;
...
import com.hybris.commercesearch.searchandizing.cockpit.constants.SearchandizingcockpitConstants;




/**
 * This is the extension manager of the Searchandizingcockpit extension.
 */
public class SearchandizingcockpitManager extends GeneratedSearchandizingcockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SearchandizingcockpitManager.class.getName());
	 ...
	 */
	public static SearchandizingcockpitManager getInstance()
	{
		return (SearchandizingcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SearchandizingcockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SearchandizingcockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SearchandizingcockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SearchandizingcockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SearchandizingcockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
