 ...
 */
package com.sptel.cockpits.setup;
...
import com.sptel.cockpits.constants.SptelCockpitsConstants;
 ...
 */
@SystemSetup(extension = SptelCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SptelCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SptelCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SptelCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/sptelcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
