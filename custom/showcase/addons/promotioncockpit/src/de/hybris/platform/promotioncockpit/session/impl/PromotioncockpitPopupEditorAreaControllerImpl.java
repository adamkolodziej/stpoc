...
/**
 * Promotioncockpit popup editor area controller.
 */
public class PromotioncockpitPopupEditorAreaControllerImpl extends DefaultEditorAreaController implements PopupEditorAreaController
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PromotioncockpitPopupEditorAreaControllerImpl.class);
