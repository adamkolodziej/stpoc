 ...
 *  
 */
package com.hybris.showcase.cecs.mobiletricast.jalo;
...
/**
 * This is the extension manager of the Mobiletricast extension.
 */
public class MobiletricastManager extends GeneratedMobiletricastManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MobiletricastManager.class.getName());
	 ...
	 */
	public static MobiletricastManager getInstance()
	{
		return (MobiletricastManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MobiletricastConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MobiletricastManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MobiletricastManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MobiletricastManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MobiletricastManager called, current tenant: " + getTenant().getTenantID());
		}
	}
