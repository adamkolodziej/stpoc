 ...
 *
 */
package com.hybris.showcase.instantcheckout.jalo;
...
import com.hybris.showcase.instantcheckout.constants.InstantcheckoutaddonConstants;



/**
 * This is the extension manager of the Instantcheckoutaddon extension.
 */
public class InstantcheckoutaddonManager extends GeneratedInstantcheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(InstantcheckoutaddonManager.class.getName());
	 ...
	 */
	public static InstantcheckoutaddonManager getInstance()
	{
		return (InstantcheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				InstantcheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public InstantcheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InstantcheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of InstantcheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of InstantcheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
