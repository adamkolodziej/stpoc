 ...
 *  
 */
package com.hybris.showcase.tricastextrasampledata.jalo;
...
/**
 * This is the extension manager of the Tricastextrasampledata extension.
 */
public class TricastextrasampledataManager extends GeneratedTricastextrasampledataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TricastextrasampledataManager.class.getName());
	 ...
	 */
	public static TricastextrasampledataManager getInstance()
	{
		return (TricastextrasampledataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TricastextrasampledataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TricastextrasampledataManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TricastextrasampledataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TricastextrasampledataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TricastextrasampledataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
