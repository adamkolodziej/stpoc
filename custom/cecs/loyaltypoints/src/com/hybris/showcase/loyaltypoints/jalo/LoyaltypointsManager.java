...
/**
 * This is the extension manager of the Loyaltypoints extension.
 */
public class LoyaltypointsManager extends GeneratedLoyaltypointsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LoyaltypointsManager.class.getName());
	 ...
	 */
	public static LoyaltypointsManager getInstance()
	{
		return (LoyaltypointsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LoyaltypointsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LoyaltypointsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LoyaltypointsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LoyaltypointsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LoyaltypointsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
