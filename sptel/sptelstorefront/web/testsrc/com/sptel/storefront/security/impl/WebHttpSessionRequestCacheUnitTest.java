...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sptelstorefront/electronics/en",
						"https://electronics.local:9002/sptelstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sptelstorefront/electronics/en",
						"https://electronics.local:9002/sptelstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sptelstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sptelstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sptelstorefront/electronics/en",
						"https://electronics.local:9002/sptelstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sptelstorefront",
						"https://electronics.local:9002/sptelstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sptelstorefront",
						"https://electronics.local:9002/sptelstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sptelstorefront/electronics/en",
						"https://electronics.local:9002/sptelstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
