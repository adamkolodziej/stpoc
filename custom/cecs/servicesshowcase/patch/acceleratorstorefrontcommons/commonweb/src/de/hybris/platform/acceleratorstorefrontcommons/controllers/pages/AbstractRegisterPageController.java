...
import com.hybris.showcase.callbacks.RegistrationCallback;
import com.hybris.showcase.callbacks.RegistrationException;

/*
 * PATCH: This file comes from *servicesshowcase* extension. 
 * 
 * All the changes we made should be annotated with TRICAST START/END comments
 */
public abstract class AbstractRegisterPageController extends AbstractPageController
{
	...
	// TRICAST START
	@Autowired
	private List<RegistrationCallback> registrationCallbacks;
	// TRICAST END
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		{
			// TRICAST START
			for (final RegistrationCallback callback : registrationCallbacks)
			{
				callback.beforeRegister(data);
			}
