...
<%-- CECS-53 integrate angularjs START --%>
<script type="text/javascript" src="${commonResourcePath}/js/angular.min.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/angular-resource.min.js"></script>
<%-- CECS-53 integrate angularjs END --%>
