 ...
 *  
 */
package com.hybris.facebookmockup.jalo;
...
import com.hybris.facebookmockup.constants.FacebookmockupConstants;



/**
 * This is the extension manager of the Facebookmockup extension.
 */
public class FacebookmockupManager extends GeneratedFacebookmockupManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacebookmockupManager.class.getName());
	 ...
	 */
	public static FacebookmockupManager getInstance()
	{
		return (FacebookmockupManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacebookmockupConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacebookmockupManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacebookmockupManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacebookmockupManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacebookmockupManager called, current tenant: " + getTenant().getTenantID());
		}
	}
