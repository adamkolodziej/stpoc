                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <span class="glyphicon glyphicon-search color-blue font-24 margin-left-30 cursor-pointer" aria-hidden="true" data-toggle="modal" data-target="#search-modal"></span>
                        </div>
                    </div>
                                ...
                                <div class="row margin-bottom-20">
                                    <div class="col-xs-8">
                                        <ul class="nav nav-tabs nav-custom" role="tablist">
                                            <li role="presentation" class="active"><a href="#new-orders" aria-controls="new-quotations" role="tab" data-toggle="tab">New orders</a></li>
                                            <li role="presentation"><a href="#sla-close-by" aria-controls="sla-close-by" role="tab" data-toggle="tab">SLA close by</a></li>
                                            <li role="presentation"><a href="#closed" aria-controls="closed" role="tab" data-toggle="tab">Closed</a></li>
                                            <li role="presentation"><a href="#show-all" aria-controls="show-all" role="tab" data-toggle="tab">Show all</a></li>
                                        </ul>
                                    </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span data-toggle="modal" data-target="#order-modal">Open</span></td>
                                                    <td>2016-10-09</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>0</td>
                                                    <!-- Toggle for modal window -->
                                                    <td><span data-toggle="modal" data-target="#order-modal">Closed</span></td>
                                                    <td>2016-10-09</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">CC03-25</th>
