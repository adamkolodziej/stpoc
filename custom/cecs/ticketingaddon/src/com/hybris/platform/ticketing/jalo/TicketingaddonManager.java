 ...
 *
 */
package com.hybris.platform.ticketing.jalo;
...
import com.hybris.platform.ticketing.constants.TicketingaddonConstants;



/**
 * This is the extension manager of the Ticketingaddon extension.
 */
public class TicketingaddonManager extends GeneratedTicketingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TicketingaddonManager.class.getName());
	 ...
	 */
	public static TicketingaddonManager getInstance()
	{
		return (TicketingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TicketingaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TicketingaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TicketingaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TicketingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TicketingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
