 ...
 *  
 */
package com.hybris.solrrollup.jalo;
...
import com.hybris.solrrollup.constants.SolrrollupConstants;



/**
 * This is the extension manager of the Solrrollup extension.
 */
public class SolrrollupManager extends GeneratedSolrrollupManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SolrrollupManager.class.getName());
	 ...
	 */
	public static SolrrollupManager getInstance()
	{
		return (SolrrollupManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SolrrollupConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SolrrollupManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SolrrollupManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SolrrollupManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SolrrollupManager called, current tenant: " + getTenant().getTenantID());
		}
	}
