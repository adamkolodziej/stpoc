...
public class DefaultSptelcoreService implements SptelcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSptelcoreService.class);
	...
	{
		return DefaultSptelcoreService.class.getResourceAsStream("/sptelcore/sap-hybris-platform.png");
	}
