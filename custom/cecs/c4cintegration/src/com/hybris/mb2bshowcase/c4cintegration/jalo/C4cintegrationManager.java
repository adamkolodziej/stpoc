 ...
 *  
 */
package com.hybris.mb2bshowcase.c4cintegration.jalo;
...
import com.hybris.mb2bshowcase.c4cintegration.constants.C4cintegrationConstants;



/**
 * This is the extension manager of the C4cintegration extension.
 */
public class C4cintegrationManager extends GeneratedC4cintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(C4cintegrationManager.class.getName());
	 ...
	 */
	public static C4cintegrationManager getInstance()
	{
		return (C4cintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				C4cintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public C4cintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of C4cintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of C4cintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of C4cintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
