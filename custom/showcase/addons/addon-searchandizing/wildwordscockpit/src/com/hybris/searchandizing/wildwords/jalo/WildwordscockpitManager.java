 ...
 * 
 */
package com.hybris.searchandizing.wildwords.jalo;
...
import com.hybris.searchandizing.wildwords.constants.WildwordscockpitConstants;



/**
 * This is the extension manager of the Wildwordscockpit extension.
 */
public class WildwordscockpitManager extends GeneratedWildwordscockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WildwordscockpitManager.class.getName());
	 ...
	 */
	public static WildwordscockpitManager getInstance()
	{
		return (WildwordscockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WildwordscockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WildwordscockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WildwordscockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WildwordscockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WildwordscockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
