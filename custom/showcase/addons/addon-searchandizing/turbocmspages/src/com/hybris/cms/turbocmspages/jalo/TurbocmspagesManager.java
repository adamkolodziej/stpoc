 ...
 * 
 */
package com.hybris.cms.turbocmspages.jalo;
...
import com.hybris.cms.turbocmspages.constants.TurbocmspagesConstants;



/**
 * This is the extension manager of the Turbocmspages extension.
 */
public class TurbocmspagesManager extends GeneratedTurbocmspagesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TurbocmspagesManager.class.getName());
	 ...
	 */
	public static TurbocmspagesManager getInstance()
	{
		return (TurbocmspagesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TurbocmspagesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TurbocmspagesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TurbocmspagesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TurbocmspagesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TurbocmspagesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
