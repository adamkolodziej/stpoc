 ...
 *  
 */
package com.hybris.productlists.jalo;
...
import com.hybris.productlists.jalo.GeneratedProductlistsManager;



/**
 * This is the extension manager of the Productlists extension.
 */
public class ProductlistsManager extends GeneratedProductlistsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductlistsManager.class.getName());
	 ...
	 */
	public static ProductlistsManager getInstance()
	{
		return (ProductlistsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ProductlistsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductlistsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductlistsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductlistsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductlistsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
